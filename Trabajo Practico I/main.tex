...
Queremos partir el dataset de manera de tener una partición de held-out (conjunto de control o de evaluación) con la que evaluar, al final del trabajo, la configuración que elijamos. 
...
Lo implementamos con los métodos \texttt{groupby} (agrupar por target) y luego \texttt{sample} (tomar una muestra al azar) de Pandas, fijando una semilla para que la partición sea reproducible. 
Queremos $0,15 \cdot 359$ de etiqueta 0 y $0,15 \cdot 141$ de etiqueta 1, o sea, 54 y 21 respectivamente, lo que deja un held-out de 75 instancias y un conjunto de desarrollo de 425.
